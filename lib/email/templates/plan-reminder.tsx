...
<head>
    ...
    <style>
        ...
        @media (prefers-color-scheme: dark) {
            ...
            table[bgcolor="#ffffff"] { background-color: #2d3748 !important; }
            h1 { color: #f7fafc !important; }
            p { color: #e2e8f0 !important; }
            td[style*="background-color: #f7fafc"] { background-color: #374151 !important; }
            td[style*="border: 2px solid #e2e8f0"] { border-color: #4a5568 !important; }
            div[style*="color: #2d3748"] { color: #f7fafc !important; }
            p[style*="color: #4a5568"] { color: #e2e8f0 !important; }
            p[style*="color: #718096"] { color: #a0aec0 !important; }
        }
    </style>
</head>
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 30px;">
                                        ...
                                        <div style="margin-bottom: 10px;">
                                            <svg width="56" height="56" viewBox="0 0 34 34" fill="#6d3a9c" xmlns="http://www.w3.org/2000/svg">
